...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        caretHeight = getResources().getDimension(Utility.resId_likeboxcountview_caret_height);
        caretWidth = getResources().getDimension(Utility.resId_likeboxcountview_caret_width);
        borderRadius = getResources().getDimension(Utility.resId_likeboxcountview_border_radius);

        borderPaint = new Paint();
        borderPaint.setColor(getResources().getColor(Utility.resId_likeboxcountview_border_color));
        borderPaint.setStrokeWidth(getResources().getDimension(Utility.resId_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        likeCountLabel.setTextSize(
                ...
                getResources().getDimension(Utility.resId_likeboxcountview_text_size));
        likeCountLabel.setTextColor(getResources().getColor(Utility.resId_likeboxcountview_text_color));
        textPadding = getResources().getDimensionPixelSize(Utility.resId_likeboxcountview_text_padding);

        // Calculate the additional text padding that will be applied in the direction of the caret.
        additionalTextPadding = getResources().getDimensionPixelSize(Utility.resId_likeboxcountview_caret_height);
    }
